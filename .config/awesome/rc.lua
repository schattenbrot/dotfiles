...
globalkeys = gears.table.join(
  ...
  awful.key({ modkey, }, "d",
    function() awful.spawn("rofi -modi drun -show drun -config ~/.config/rofi/rofidmenu.rasi") end,
  ...
  awful.key({}, "XF86AudioRaiseVolume", function() awful.spawn("amixer -q sset Master 5%+") end,
    { description = "increase Audio Volume", group = "launcher" }),
  awful.key({}, "XF86AudioLowerVolume", function() awful.spawn("amixer -q sset Master 5%-") end,
    { description = "fix background", group = "launcher" }),
  awful.key({}, "XF86MonBrightnessDown", function() awful.spawn("/user/bin/xbacklight -dec 10") end,
...
awful.spawn.with_shell("feh --bg-scale /home/ellychan/Pictures/konpaku_youmu.jpg")
